export default {
    ...
    messages: {
        ...
        confirmClear: '即将清除当前单词数据，重新抓取，是否继续？',
        clearOperation: '清除操作'
    },
    ...
    time: {
        ...
        minute20: '20分钟',
        minute30: '30分钟',
        countdownPrompt: '停留3秒时间，请在脑海联想对应的单词或句子'
    },
    ...
    languages: {
        ...
        'Traditional TW Chinese': '繁体中文（台湾）',
        'Traditional HK Chinese': '繁体中文（香港）',
        Japanese: '日语',
        Korean: '韩语',
        French: '法语',
        German: '德语',
