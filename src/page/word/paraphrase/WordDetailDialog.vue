    ...
    <el-card class="word-content-card">
      ...
      <div slot="header" class="word-header">
        ...
        <PronunciationSection
            v-if="detail.paraphraseVO && detail.paraphraseVO.pronunciationVOList"
        ...
        >
          ...
          >
            <div slot="title" class="definition-content">
              <!-- Phrases -->
              <div v-if="detail.paraphraseVO && detail.paraphraseVO.phraseList && detail.paraphraseVO.phraseList.length > 0" class="phrase-section">
                <el-tag
              ...
              <!-- Codes -->
              <p v-if="detail.paraphraseVO && detail.paraphraseVO.codes" class="word-codes">
                {{ detail.paraphraseVO.codes }}
              </p>

              <!-- English Definition -->
              <div class="english-definition">
                {{ (detail.paraphraseVO && detail.paraphraseVO.paraphraseEnglish) || '' }}
              </div>
            </div>
          </el-alert>
        </div>
      ...
      <div class="examples-section">
        <!-- No Examples Alert -->
        <el-alert
            v-if="!detail.paraphraseVO || !detail.paraphraseVO.exampleVOList || detail.paraphraseVO.exampleVOList.length === 0"
            type="info"
            title="该释义暂时没有例句"
            center
            effect="light"
        ...
        <!-- Example Items -->
        <div
            v-for="example in (detail.paraphraseVO && detail.paraphraseVO.exampleVOList) || []"
            :key="example.id || example.exampleSentence"
            @click="toggleTranslation"
            class="example-item"
        >
          <el-alert
